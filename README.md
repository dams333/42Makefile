...
- You can add some compilation flags (like `-l` flags to add standard libraries) with the variable `CFLAGS` _(Classic flags are generated by make command's falgs, view below)_
